<template>
  <div class="card" style="width: 50%">
    <div style="font-size: 18px; font-weight: bold">个人中心</div>

    <el-form ref="formRef" :model="data.user" label-width="80px" style="padding: 20px 30px 10px 0">
      <el-form-item prop="username" label="账号">
        <el-input  v-model="data.user.username" autocomplete="off" placeholder="请输入账号" readonly/>
      </el-form-item>
      ...
      <el-form-item prop="avatar" label="头像">
        <el-upload
            ...
            list-type="picture"
        >
          <el-button type="primary">{{ data.user.avatar ? '更换头像' : '上传头像' }}</el-button>
        </el-upload>
      </el-form-item>
    </el-form>
    <div style="text-align: center">
      <el-button type="primary" style="padding: 15px 80px" @click="update">保 存</el-button>
    </div>
  </div>
</template>
